...
.. important::
   To access contract templates, the :guilabel:`Salary Configurator` module **must** be installed.
...
calendar` button in the to-left. This creates entries for an :guilabel:`Even week` and an
:guilabel:`Odd week`.
